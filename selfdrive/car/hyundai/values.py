...
class CAR(Platforms):
  ...
  GENESIS_GV70_1ST_GEN = HyundaiCanFDPlatformConfig(
    [
      ...
      HyundaiCarDocs("Genesis GV70 (3.5T Trim) 2022-23 HDA", "Highway Driving Assist", car_parts=CarParts.common([CarHarness.hyundai_m])),
      HyundaiCarDocs("Genesis GV70 (3.5T Trim) 2022-23 HDAII", "Highway Driving Assist II", car_parts=CarParts.common([CarHarness.hyundai_s])),
    ],
